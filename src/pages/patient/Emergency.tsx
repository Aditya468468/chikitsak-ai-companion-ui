...
import { Ambulance, Phone, AlertTriangle, ShieldAlert, Heart, LifeBuoy } from "lucide-react";
...
export default function Emergency() {
  ...
  const [emergencyContacts, setEmergencyContacts] = useState([
    ...
    { name: "Primary Doctor", phone: "555-123-4567" }
  ]);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
              <Card className="bg-destructive/10 border-destructive/30">
                ...
                <CardContent>
                  ...
                  <p className="text-xs mt-3 text-muted-foreground">
                    Press only in case of genuine emergency. This will connect you directly to local emergency services.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-orange-300 bg-orange-50/50">
                ...
                <CardContent>
                  ...
                  <Button variant="outline" className="w-full mt-4">Edit Medical ID</Button>
                </CardContent>
              </Card>
